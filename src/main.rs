...
use agent::provider::{load_providers_registry, ApiProtocol, ProviderConfig, ProvidersRegistry};
use anyhow::Result;
...
fn auto_save_if_code_generated(
    prompt: &str,
    final_content: &str,
...
fn main() -> Result<()> {
    ...
    match cli.command {
        Some(Commands::Serve { port, host }) => {
            ...
            println!("Serving visual dashboard from index.html");
